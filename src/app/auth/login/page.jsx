    ...
    <>
      ...
      <div className="">
        <div
          ...
          className="m-auto items-start items-center w-full max-w-[1140px] min-h-[100vh] pt-[100px]"
        >
          <Formik
          ...
          >
            <Form className=" m-0 m-auto max-w-[375px]  bg-white p-[20px] flex-col space-y-[15px]">
              <h1 className="text-xl text-[#bdbdbd] text-center">
                <Link className="text-[#444444] pointer-events-none" href="/">
                  Đăng nhập{" "}
                </Link>
                <span> </span>
                hoặc
                <span> </span>
                <Link
                  className="underline hover:text-[#2f5978]"
                  href="/auth/register"
                >
                  Đăng ký
                </Link>
              ...
              <p className="text-[14px] text-[#a94442]">
              ...
              <div className="flex justify-between">
                <div className="flex items-center">
                  <input id="remember" type="checkbox" className="w-[18px]" />
                  <label
                    htmlFor="remember"
                    className="cursor-pointer text-[14px] ml-1"
                  >
                    Lưu đăng nhập
                  </label>
                </div>
                <Link
                  href="/"
                  className="text-[14px] text-[#4582af] hover:underline hover:text-[#2f5978]"
                >
                  Quên mật khẩu
                </Link>
              </div>
